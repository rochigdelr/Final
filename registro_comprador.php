...
if(isset($_POST["submit"])){
    ...
    if($pass == $pass2){
        ...
        if(!$result->num_rows > 0){
            $sql="INSERT INTO users (username, email, pass, firstname, lastname, phone, id_rol) VALUES ('$username', '$email', '$pass','$firstname', '$lastname', '$phone', '$id_rol')";
            $result=mysqli_query($conexion, $sql);
            if($result){
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input name="phone" type="tel" class="form-control form-control-user" id="exampleInputEmail"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="pass" type="password" class="form-control form-control-user"
                                            id="exampleInputUsername" placeholder="Contraseña">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <!--<a href="perfilcomprador.html" class="btn btn-primary btn-user btn-block">
                                    Registrate
                                </a>
                                <hr>
